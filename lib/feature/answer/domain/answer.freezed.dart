...
abstract class $AnswerCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Sentence> sentenceList, int nBackNum});
}
...
class _$_Answer with DiagnosticableTreeMixin implements _Answer {
  const _$_Answer(
      {final List<Sentence> sentenceList = const [], this.nBackNum = 1})
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Answer(sentenceList: $sentenceList, nBackNum: $nBackNum)';
  }
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_sentenceList), nBackNum);
...
abstract class _Answer implements Answer {
  const factory _Answer(
      {final List<Sentence> sentenceList, final int nBackNum}) = _$_Answer;
